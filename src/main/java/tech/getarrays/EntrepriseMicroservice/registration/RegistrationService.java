...
import tech.getarrays.EntrepriseMicroservice.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = entrepriseService.addEntreprise(
                new Entreprise(
        ...
        String link = "http://localhost:8050/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        entrepriseService.enableEntreprise(
                confirmationToken.getEntreprise().getEmail());
        return "confirmed";
    }
